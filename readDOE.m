...
fileID1=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_intHeat_.txt",'w');
fileID2=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_intHeatNight_.txt",'w');
fileID3=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_intHeatDay_.txt",'w');
fileID4=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_intHeatFRad_.txt",'w');
fileID5=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_intHeatFLat_.txt",'w');
fileID6=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_infil_.txt",'w');
fileID7=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_vent_.txt",'w');
fileID8=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_glazingRatio_.txt",'w');
fileID9=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_uValue_.txt",'w');
fileID10=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_shgc_.txt",'w');
fileID11=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_condType_.txt",'w');
fileID12=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_cop_.txt",'w');
fileID13=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_coolSetpointDay_.txt",'w');
fileID14=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_coolSetpointNight_.txt",'w');
fileID15=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_heatSetpointDay_.txt",'w');
fileID16=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_heatSetpointNight_.txt",'w');
fileID17=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_coolCap_.txt",'w');
fileID18=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_heatEff_.txt",'w');
fileID19=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_mSys_.txt",'w');
fileID20=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_indoorTemp_.txt",'w');
fileID21=fopen("../UWG_Python/tests/matlab_ref/matlab_readDOE/matlab_ref_indoorHum_.txt",'w');
...
for i = 1:16
    ...
    %disp('---i---');
    %format long;
    %disp(RvalRoof);%(2,2));%(1,4)); 2.666666666666667
    %disp(Effheat);
    %disp('----f----');
    ...
    for j = 1:3
        ...
        for k = 1:16
            ...
            fprintf(fileID1,'%.16f\n',refDOE(i,j,k).intHeat);
            fprintf(fileID2,'%.16f\n',refDOE(i,j,k).intHeatNight);
            fprintf(fileID3,'%.16f\n',refDOE(i,j,k).intHeatDay);
            fprintf(fileID4,'%.16f\n',refDOE(i,j,k).intHeatFRad);
            fprintf(fileID5,'%.16f\n',refDOE(i,j,k).intHeatFLat);
            fprintf(fileID6,'%.16f\n',refDOE(i,j,k).infil);
            fprintf(fileID7,'%.16f\n',refDOE(i,j,k).vent);
            fprintf(fileID8,'%.16f\n',refDOE(i,j,k).glazingRatio);
            fprintf(fileID9,'%.16f\n',refDOE(i,j,k).uValue);
            fprintf(fileID10,'%.16f\n',refDOE(i,j,k).shgc);
            fprintf(fileID11,'%s\n', refDOE(i,j,k).condType);
            fprintf(fileID12,'%.16f\n',refDOE(i,j,k).cop);
            fprintf(fileID13,'%.16f\n',refDOE(i,j,k).coolSetpointDay);
            fprintf(fileID14,'%.16f\n',refDOE(i,j,k).coolSetpointNight);
            fprintf(fileID15,'%.16f\n',refDOE(i,j,k).heatSetpointDay);
            fprintf(fileID16,'%.16f\n',refDOE(i,j,k).heatSetpointNight);
            fprintf(fileID17,'%.16f\n',refDOE(i,j,k).coolCap);
            fprintf(fileID18,'%.16f\n',refDOE(i,j,k).heatEff);
            fprintf(fileID19,'%.16f\n',refDOE(i,j,k).mSys);
            fprintf(fileID20,'%.16f\n',refDOE(i,j,k).indoorTemp);
